...
export default {
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "sub-web作者提供(api.wcc.best)": "https://api.wcc.best/sub?",
          "subconverter作者提供(subcon.dlj.t)":"https://subcon.dlj.tf/sub?",
          "sub作者&lhie1提供(api.dler.io)": "https://api.dler.io/sub?",
          "nameless13提供(www.nameless13.com)":"https://www.nameless13.com/sub?",
          "猫熊提供(sub.maoxiongnet.com)":"https://sub.maoxiongnet.com/sub?",
          "品云提供(sub.id9.cc)": "https://sub.id9.cc/sub?",
          "肥羊增强型后端【负载均衡】(api.v1.mk/sub)":"https://api.v1.mk/sub?",
          "本站自用": "https://suc.ystwj.top/sub?",
        },
        backendOptions: [
        ...
        remoteConfig: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                label: "通用（附带用于 Clash 的 AdGuard DNS）",
  ...
  created() {
    document.title = "Subscription Converter 在线订阅转换";
